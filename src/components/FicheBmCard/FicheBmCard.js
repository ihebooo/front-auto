...
import './FicheBmCard.css'
import ModalPopup from "../popup/popup";
import { SecondaryButton } from '../../components/index'

const FicheBmCard = (props) => {
    ...
    <div className='gaming-card ' >
      ...
      download={props.download}setShow={setShow} show={show} />}
        ...
        <ul>
            ...
            <li><h4>Vitesse Max</h4><span>{props.date_added}</span></li>
            <li><h4>Preparateur</h4><span>{props.hours_played}</span></li>
            <li><h4>Nombre Cylindre</h4><span>{props.download}</span></li>
